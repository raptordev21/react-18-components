...
export default function Select({ value, onChange, options, size = 'SM' }: SelectProps) {
  ...
  return (
    ...
    >
      <span className={`${sizeStyles.textSize} flex-grow font-light text-left`}>{value?.label}</span>
